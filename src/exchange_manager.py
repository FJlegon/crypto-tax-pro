...
EXCHANGES: dict[str, ExchangeConfig] = {
    ...
    "binanceus": ExchangeConfig(
        ...
        color="#f0b90b",
        file_type="trades",
        required_cols={"Date", "Type", "Market", "Amount", "Price", "Total"},
        optional_cols={"Fee"},
        guide=[
            "1. Log in to Binance.US → Wallet → Transaction History.",
            "2. Click 'Export' to download trade history.",
    ...
    "etherscan": ExchangeConfig(
        ...
        guide=[
            ...
            "2. Optionally add an Etherscan API key for higher rate limits",
            "3. Click 'Sync' to fetch transactions from the blockchain",
            "Note: Transactions are fetched directly from Etherscan API.",
        ],
        export_url="https://etherscan.io/",
        enabled=True,
        coming_soon=False,
    ),
